...
/**
 * @ClassName: MineChangePhoneActivity
 * @Description:
 * @Author: yxy
 * @Date: 2022/7/26 10:27
 */
@Route(path = AppConstant.RoutePath.MINE_CHANGE_PHONE_ACTIVITY)
class MineChangePhoneActivity : BaseActivity<ActMineChangePhoneBinding>() {

    @InjectViewModel
    lateinit var mineViewModel: MineViewModel

    override fun initViewBinding(): ActMineChangePhoneBinding {
        return bind(ActMineChangePhoneBinding::inflate)
    }
