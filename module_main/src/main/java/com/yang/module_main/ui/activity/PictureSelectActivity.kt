...
import com.yang.module_main.databinding.ActPictureSelectBinding
...
class PictureSelectActivity : BaseActivity<ActPictureSelectBinding>() {
    ...
    override fun initViewBinding(): ActPictureSelectBinding {
        return bind(ActPictureSelectBinding::inflate)
    }
    ...
    private fun initRecyclerView() {
        (mViewBinding.recyclerView.itemAnimator as SimpleItemAnimator).supportsChangeAnimations = false
